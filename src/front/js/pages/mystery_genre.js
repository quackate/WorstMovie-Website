...
export const Mystery_Genre = () => {
	...
	return (
		<div className="genrepage-wrapper">
            <h1 className="genrepage-title mb-5 text-center"><span className="genrepage-purple">Mystery</span> Movies <i className="fas fa-film film-icon"></i></h1>
			<div className="">
					{store.mystery_movies?.map((movies) => (
