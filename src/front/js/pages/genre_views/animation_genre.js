...
export const Animation_Genre = () => {
	...
	return (
		<div className="genrepage-wrapper">
            <h1 className="genrepage-title mb-5 text-center"><span className="genrepage-purple">Animation</span> Movies <i className="fas fa-film film-icon"></i></h1>
			<div className="">
					{store.animation_movies?.map((movies) => (
