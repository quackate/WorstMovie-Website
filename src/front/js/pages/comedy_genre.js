...
export const Comedy_Genre = () => {
	const { store, actions } = useContext(Context);
	
	return (
		<div className="genrepage-wrapper">
            <h1 className="genrepage-title mb-5 text-center"><span className="genrepage-purple">Comedy</span> Movies <i className="fas fa-film film-icon"></i></h1>
			<div className="">
					{store.comedy_movies?.map((movies) => (
